...
//                }
            ...
            conn = DriverManager.getConnection("jdbc:sqlite:d:\\rtscm.db");
...
//            String site = new String("http://localhost:8084/FormGen/userprofile.jsp");
...
%>
<form>
<br><input type="submit" value="delete" onclick ="this.form.action='delete.jsp';"/>
    <input type="submit" value="display" onclick ="this.form.action='display.jsp';"/><br>
    </form>
<div class="footer-w3">
